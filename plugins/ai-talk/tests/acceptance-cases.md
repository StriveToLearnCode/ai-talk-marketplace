...
```text
$ai-talk 修改 pages/recharge.vue 的奖励卡片布局和点击选中态，完成后直接验证。
```
...
```text
$ai-talk 修改 src/services/reward.ts 的接口错误映射，不改变页面展示。
```
